    ...
    for (const propertyName in definition.properties) {
        if (definition.properties.hasOwnProperty(propertyName)) {
            ...
            const propertyValues = {
                name: camelCase__default["default"](escapeName(propertyName)),
                description: property.description || null,
...
var partialExportEnum = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	"
    + ((stack1 = lookupProperty(helpers,"pascalCase").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(depth0,"name"),{"name":"pascalCase","hash":{},"data":data,"loc":{"start":{"line":21,"column":1},"end":{"line":21,"column":22}}})) != null ? stack1 : "")
    + " = "
    + ((stack1 = container.lambda(container.strict(depth0, "value", {"start":{"line":21,"column":28},"end":{"line":21,"column":33}} ), depth0)) != null ? stack1 : "")
    + ",\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {}), lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
...
var partialExportInterface = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = lookupProperty(helpers,"ifdef").call(alias1,lookupProperty(depth0,"description"),lookupProperty(depth0,"deprecated"),{"name":"ifdef","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":10,"column":10}}})) != null ? stack1 : "")
    + "export interface "
    + ((stack1 = container.lambda(container.strict(depth0, "name", {"start":{"line":11,"column":20},"end":{"line":11,"column":24}} ), depth0)) != null ? stack1 : "")
    + " {\n"
...
var partialIsNullable = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(depth0,"isNullable"),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":27},"end":{"line":1,"column":59}}})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data) {
    return " | null";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(lookupProperty(data,"root"),"writeNullable"),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":1,"column":66}}})) != null ? stack1 : "");
},"useData":true};
...
const registerHandlebarHelpers = (root) => {
    ...
    runtime.registerHelper('containsDots', function (value, options) {
        return /\.+/.test(value) ? options.fn(this) : options.inverse(this);
    });
    runtime.registerHelper('isNumber', function (value, options) {
        return parseFloat(value) !== NaN ? options.fn(this) : options.inverse(this);
    });
    ...
    runtime.registerHelper('pascalCase', function (value) {
        return camelCase__default["default"](value, { pascalCase: true });
    });
};
 ...
 * @param indent Indentation options (4, 2 or tab)
 */
const writeClientModels = async (models, templates, outputPath, httpClient, useUnionTypes, writeNullable, indent) => {
 ...
 * @param request Path to custom request file
 */
const writeClient = async (client, templates, output, httpClient, useOptions, useUnionTypes, exportCore, exportServices, exportModels, exportSchemas, writeNullable, indent, postfix, clientName, request) => {
 ...
 */
const generate = async ({ input, output, httpClient = exports.HttpClient.FETCH, clientName, useOptions = false, useUnionTypes = false, exportCore = true, exportServices = true, exportModels = true, exportSchemas = false, writeNullable = true, indent = exports.Indent.SPACE_4, postfix = 'Service', request, write = true, }) => {
    ...
    switch (openApiVersion) {
        case OpenApiVersion.V2: {
            ...
            if (!write)
                break;
            await writeClient(clientFinal, templates, output, httpClient, useOptions, useUnionTypes, exportCore, exportServices, exportModels, exportSchemas, writeNullable, indent, postfix, clientName, request);
            break;
        }
